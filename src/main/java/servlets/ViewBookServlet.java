...
//            button = "<form action=\"viewbook\" method=\"post\">"
            button = "<form action=\"cart\" method=\"post\">"
        ...
        String imagePath = book.getImagePath() != null ? book.getImagePath() : "images/default.jpg";
        // Bootstrap card to show the book data
        return "<div class=\"card\">\r\n"
                + "                <div class=\"row card-body\">\r\n"
                + "                    <img class=\"col-sm-6\" src=\"" + imagePath + "\" alt=\"Card image cap\" width='100' height='100'>\r\n"
                + "                    <div class=\"col-sm-6\">\r\n"
